...
class MiniCart extends AbstractBlock {
	...
	protected function get_markup( $attributes ) {
		...
		$icon_size      = ! empty( $attributes['iconSize'] ) ? $attributes['iconSize'] : 25;
		...
		$icon        = '<svg class="wc-block-mini-cart__icon" width="' . $icon_size . '" height="' . $icon_size . '" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">

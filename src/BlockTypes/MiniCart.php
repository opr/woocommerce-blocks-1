...
class MiniCart extends AbstractBlock {
	...
	/**
	 *  Active Mini Cart icon setting.
	 *
	 * @var string
	 */
	protected $icon_setting = '';
	...
	protected function enqueue_data( array $attributes = [] ) {
		...
		$this->icon_setting = wp_get_global_settings( [ 'custom', 'icon' ], [ 'block_name' => 'woocommerce/mini-cart' ] );

		// Hydrate the following data if it's available.
		if ( ! empty( $this->icon_setting ) ) {
